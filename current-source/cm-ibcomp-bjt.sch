...
.endc"}
C {devices/ammeter.sym} 220 -180 0 0 {name=Viout savecurrent=true}
...
C {devices/isource.sym} 100 -280 0 0 {name=Iref value=1m}
C {devices/ammeter.sym} 100 -180 0 0 {name=Vic savecurrent=true}
C {devices/ammeter.sym} 160 -150 0 0 {name=Vib savecurrent=true}
C {devices/vsource.sym} 350 -130 0 0 {name=Vout value=1.2 savecurrent=false}
C {symbols/npn_10p00x10p00.sym} 140 -230 0 0 {name=Q3
model=npn_10p00x10p00
spiceprefix=X
m=1}
C {devices/code_shown.sym} -280 -340 0 0 {name=measure only_toplevel=false value=".measure dc i1p5 find i(Viout) at=1.5
