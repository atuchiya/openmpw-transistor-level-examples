...
let vds=v(vds)
plot -i(vds)
plot 1/@m.xm1.msky130_fd_pr__pfet_01v8_lvt[gds]
plot @m.xm1.msky130_fd_pr__pfet_01v8_lvt[gds]/vds
wrdata sky130A_pfet_01v8lvt_idvds_id.txt -i(vds)
wrdata sky130A_pfet_01v8lvt_idvds_rds.txt 1/@m.xm1.msky130_fd_pr__pfet_01v8_lvt[gds]
.endc"}
