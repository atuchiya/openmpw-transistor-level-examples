...
wrdata sky130A_pfet_01v8_subthreshold_id.txt -i(vds)
wrdata sky130A_pfet_01v8_subthreshold_sfactor.txt 1/deriv(log10(-i(vds)))
.endc"}
C {sky130_fd_pr/corner.sym} -120 -120 0 0 {name=CORNER only_toplevel=true corner=tt}
C {sky130_fd_pr/pfet_01v8.sym} 90 -130 0 0 {name=M11
L=0.15
W=1.5
nf=1 mult=1
model=pfet_01v8
