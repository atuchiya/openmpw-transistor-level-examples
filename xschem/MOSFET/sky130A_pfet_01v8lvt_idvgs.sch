...
plot @m.xm1.msky130_fd_pr__pfet_01v8_lvt[gm] vs id
wrdata sky130A_pfet_01v8lvt_idvgs_id.txt -i(vds)
wrdata sky130A_pfet_01v8lvt_idvgs_gm.txt @m.xm1.msky130_fd_pr__pfet_01v8_lvt[gm]
wrdata sky130A_pfet_01v8lvt_idvgs_gmid.txt @m.xm1.msky130_fd_pr__pfet_01v8_lvt[gm] vs id
.endc"}
C {sky130_fd_pr/corner.sym} -120 -120 0 0 {name=CORNER only_toplevel=true corner=tt}
C {sky130_fd_pr/pfet_01v8_lvt.sym} 90 -110 0 0 {name=M1
L=0.35
W=3.5
nf=1 mult=1
model=pfet_01v8_lvt
