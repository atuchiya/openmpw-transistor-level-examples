...
wrdata sky130A_fo4delay.txt in fo1_in fo1_out
.endc"}
C {devices/vsource.sym} -50 -130 0 0 {name=Vdd value=1.8}
C {devices/code_shown.sym} 10 180 0 0 {name=measure only_toplevel=false value=".measure tran trise trig v(fo1_out) val=1.44 fall=1 targ v(fo1_out) val=0.36 fall=1
...
C {devices/vsource.sym} 30 -90 0 0 {name=Vin value="pwl 0 0 10p 0 20p 1.8 300p 1.8 310p 0"}
...
C {sky130_fd_pr/pfet_01v8.sym} 170 -190 0 0 {name=M11
L=0.15
W=2
nf=1 mult=1
model=pfet_01v8
...
C {sky130_fd_pr/pfet_01v8.sym} 290 -190 0 0 {name=M1
L=0.15
W=2
nf=1 mult=1
model=pfet_01v8
...
C {sky130_fd_pr/nfet_01v8.sym} 290 -110 0 0 {name=M3
L=0.15
W=1  
nf=1 mult=1
model=nfet_01v8
...
C {sky130_fd_pr/pfet_01v8.sym} 410 -190 0 0 {name=M4
L=0.15
W=2
nf=1 mult=1
model=pfet_01v8
...
C {sky130_fd_pr/nfet_01v8.sym} 410 -110 0 0 {name=M5
L=0.15
W=1  
nf=1 mult=1
model=nfet_01v8
...
C {sky130_fd_pr/pfet_01v8.sym} 530 -190 0 0 {name=M6
L=0.15
W=2
nf=1 mult=4
model=pfet_01v8
...
C {sky130_fd_pr/nfet_01v8.sym} 530 -110 0 0 {name=M7
L=0.15
W=1
nf=1 mult=4
model=nfet_01v8
...
C {sky130_fd_pr/pfet_01v8.sym} 410 -490 0 0 {name=M8
L=0.15
W=2
nf=1 mult=3
model=pfet_01v8
...
C {sky130_fd_pr/nfet_01v8.sym} 410 -410 0 0 {name=M9
L=0.15
W=1
nf=1 mult=3
model=nfet_01v8
...
C {devices/gnd.sym} 430 -340 0 0 {name=l3 lab=GND}
C {devices/vdd.sym} 430 -570 0 0 {name=l4 lab=VDD}
C {devices/capa.sym} 530 -390 0 0 {name=Cload1
m=1
value=100f
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} 530 -340 0 0 {name=l5 lab=GND}
