...
wrdata gf180mcu_03v3_fo4delay.txt in fo1_in fo1_out
.endc"}
C {devices/vsource.sym} -50 -130 0 0 {name=Vdd value=3.3}
C {devices/code_shown.sym} 10 180 0 0 {name=measure only_toplevel=false value=".measure tran trise trig v(fo1_out) val=2.64 fall=1 targ v(fo1_out) val=0.66 fall=1
...
C {/foss/pdks/gf180mcuC/libs.tech/xschem/symbols/pfet_03v3.sym} 410 -490 0 0 {name=M9
L=0.28u
W=3u
nf=1
m=3
...
C {/foss/pdks/gf180mcuC/libs.tech/xschem/symbols/nfet_03v3.sym} 410 -410 0 0 {name=M10
L=0.28u
W=1u
nf=1
m=3
