...
wrdata gf180mcu_03v3_fo4delay.txt in fo4_in fo4_out
.endc"}
C {devices/vsource.sym} -50 -130 0 0 {name=Vdd value=vdd}
C {devices/code_shown.sym} 10 180 0 0 {name=measure only_toplevel=false value=".measure tran trise trig v(fo4_out) val='vdd * 0.8' fall=1 targ v(fo4_out) val='vdd * 0.2' fall=1
...
C {devices/code_shown.sym} -150 -270 0 0 {name=param only_toplevel=false value=".param vdd=3.3"}
