...
C {devices/vsource.sym} -160 -80 0 0 {name=Vdd value=1.8}
C {devices/vsource.sym} 40 -80 0 0 {name=Vin value=0.9
}
...
C {devices/lab_pin.sym} 170 -170 2 0 {name=p3 sig_type=std_logic lab=out}
C {devices/code_shown.sym} 240 -260 0 0 {name=control only_toplevel=false value=".option savecurrents
.control
save all
save @M1[gm]
dc Vin 0 1.8 0.02
...
C {devices/code_shown.sym} 240 -50 0 0 {name=measure only_toplevel=false value=".measure dc half when V(out)=0.9"}
